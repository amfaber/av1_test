...
fn rgb_to_yuv(rgb: RGB, scheme: YUVtoRGB) -> YUV {
...
impl Iterator for FrameIterator {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        let background = rgb_to_yuv(self.background, BT2020);
        let circle_yuv = rgb_to_yuv(self.circle_color, BT2020);
